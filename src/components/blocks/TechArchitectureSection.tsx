    ...
    <AnimatedSection className="w-full" id="architecture">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 relative">
        ...
        <GlowingCard className="p-6 sm:p-8 md:p-10 flex flex-col lg:flex-row gap-6 sm:gap-8 items-start lg:items-center bg-[#1A2642] relative overflow-hidden group">
          ...
          <div className="absolute inset-0 z-0 transition-transform duration-500 group-hover:scale-105">
            <Image
              ...
              fill
              className="object-cover opacity-10 grayscale brightness-75"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#1A2642] via-[#1A2642]/80 to-transparent" />
          </div>

          <div className="relative z-10 w-20 h-20 sm:w-24 sm:h-24 shrink-0 bg-white/10 backdrop-blur-md rounded-lg p-4 flex items-center justify-center border border-white/10 shadow-lg transition-all group-hover:bg-white/15">
            <Image
              src="/logos/digital_logo.png"
              alt="Digital Initiatives Logo"
              width={96}
          ...
          <div className="flex-1 relative z-10">
            <h3 className="text-2xl font-bold mb-2 font-display text-[#F8FAFC]">ТОО &quot;Digital Initiatives LLP&quot;</h3>
        ...
        <GlowingCard className="p-6 sm:p-8 md:p-10 flex flex-col lg:flex-row gap-6 sm:gap-8 items-start lg:items-center bg-[#1A2642] relative overflow-hidden group">
          ...
          <div className="relative z-10 w-20 h-20 sm:w-24 sm:h-24 shrink-0 bg-white rounded-lg p-4 flex items-center justify-center border border-white/10 shadow-lg transition-all group-hover:bg-white/95">
            <Image
              src="/logos/intervale_logo.jpg"
              alt="Intervale Logo"
              width={96}
          ...
          <div className="flex-1 relative z-10">
            <h3 className="text-2xl font-bold mb-2 font-display text-[#F8FAFC]">ТОО &quot;Intervale&quot;</h3>
            <ul className="space-y-3 text-slate-300">
              <li className="flex items-center gap-2">
      ...
      <div className="mt-16 surface-panel rounded-lg p-6 sm:p-8 lg:p-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 relative">
          ...
          {[
            ...
            <div key={i} className="flex flex-col items-center gap-2 relative z-10">
              <motion.div
                className="w-24 h-20 sm:w-28 sm:h-24 md:w-32 md:h-28 rounded-lg bg-slate-800 border border-white/10 flex items-center justify-center shadow-xl relative group px-2"
