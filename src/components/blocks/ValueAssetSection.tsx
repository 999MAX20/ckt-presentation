      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        <div className="flex-1 text-center lg:text-left">
          <div className="text-center lg:text-left mb-16 relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-[40px] font-bold mb-6 text-balance font-display tracking-normal leading-tight section-title">
          ...
          <GlowingCard className="relative overflow-hidden p-8 lg:p-12 mb-12 bg-[#1A2642] flex flex-col items-center text-center" glowColor="rgba(59, 130, 246, 0.15)">
            <div className="flex justify-center mb-8">
              <div className="bg-blue-600 px-4 py-2 rounded-lg text-white font-bold tracking-wide uppercase shadow-sm text-sm">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {points.map((pt, i) => (
            <GlowingCard key={i} className="p-6 flex flex-col gap-4 bg-[#1A2642]" glowColor="rgba(255, 255, 255, 0.05)">
              <div className="w-12 h-12 rounded-lg bg-[#25365A] flex items-center justify-center text-blue-400">
                <pt.icon className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-lg font-bold mb-1 font-display tracking-normal text-[#F8FAFC]">{pt.title}</h3>
